            ...
            <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6">
                        Transform Your<br />
                        Intake <span className="text-primary">With AI</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <button className="bg-primary text-white px-8 py-4 rounded-full font-medium text-lg hover:bg-opacity-90 transition-colors">
                            Get Started Free
                        </button>
                        <button className="text-primary border border-primary px-8 py-4 rounded-full font-medium text-lg hover:bg-primary hover:text-white transition-colors">
                            Learn More →
                        </button>
                    </div>
                </div>
                <div className="relative">
                    <div className="bg-white rounded-2xl p-8 shadow-2xl">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="w-20 h-8 bg-primary rounded-lg opacity-20"></div>
                        </div>
