  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            {/* Pro Plan */}
            <div className="bg-gradient-to-b from-primary to-secondary p-8 rounded-2xl relative">
                ...
                <button className="w-full py-3 px-6 bg-white text-primary rounded-full font-semibold hover:bg-gray-100 transition-colors">
                    Choose Plan
                </button>
            </div>
